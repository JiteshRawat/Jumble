...
function createbtn(){
    ...
    for(i=0;i<random.length;i++)
    {
      ...
      btn[i].classList.add("btn","btn-warning","btn1");
...
function shuffle(s) {
  ...
  var level1= ["all","and","any","are", "bad", "bet", "big", "box", "boy", "bye","can", "car", "cat", "cup", "cut", "day", "did", "dog", "dry", "eat", "eve", "fly", "for", "get", "her", "hot", "how", "huh", "man", "mom", "new", "not", "off", "old", "one", "our", "out", "pet", "put", "red", "run", "saw", "say",] 
